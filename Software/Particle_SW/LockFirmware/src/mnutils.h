...
//
// Version 20200603   New definition of allowDebugToPublish
//
...
struct structEEPROMdata {
    ...
    int lockListenType = 0;  // Holds the device type that a lock box will use to
                             // know that it should act on a checkin event it receives.
} ;
...
extern unsigned long allowDebugToPublish;  // when false, debugEvent will hold off on publishing
